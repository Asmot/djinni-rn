...
add Annotation when parser idl
support Annotation in method, between doc and method

eg add "@" to indicate to a Annotation
value only support String
      ...
      "params": [
        {
          ...
          "paramIsObject":"bool",
          "paramIsBool":"bool",
          "paramIsList":"bool", // if is List also paramIsObject is true, and the paramType will be the List's item class type
